...
My research lies at the interface of high-energy theory and gravity, where I use modern quantum field theory methods to tackle outstanding challenges in black-hole dynamics and gravitational-wave physics. My current work focuses on the analytical description of gravitational binary systems and the modelling of their waveforms by combining modern particle physics tools — such as scattering amplitudes — with traditional general relativity methods like the self-force expansion.
My dream is to develop a unified formalism that combines amplitude-based perturbation theory with self-force resummation, producing new waveform models relevant to detectors such as LIGO-VIRGO-KAGRA and LISA, and to build an international research group at the interface of amplitudes and gravitational-wave science.
