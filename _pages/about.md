...
My research lies at the interface of high-energy theory and gravity, where I use modern quantum field theory methods to tackle outstanding challenges in black-hole dynamics and gravitational-wave physics. Over the past seven years, I have worked to unify techniques from scattering amplitudes, effective field theory, and general relativity into a coherent framework for describing binary systems.
