...
<div id="waveforms" style="max-height: 1000px; overflow: hidden; transition: max-height 0.5s ease-out; text-align: justify;">
 ...
 Most recently, with F. Alessio and C. Shi, I introduced a causal framework based on Dirac brackets and coherent-state S-matrix expansions that yields <span style="color:#6c757d;font-weight:600;">a highly efficient amplitude-based recipe for radiative dynamics</span>. Within this setting, we defined a <span style="color:#6c757d;font-weight:600;">new set of classical generating functionals</span> from which all two-body scattering observables can be derived in gauge-invariant form. This novel perspective suggests important implications for the analytical modelling of inspiral waveforms.
